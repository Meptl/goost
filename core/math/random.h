...
public:
	...
	virtual Ref<RefCounted> new_instance() const { return memnew(Random); }
	...
	Array choices(const Variant &p_sequence, int p_count = 1, const PackedInt32Array &p_weights = Variant(), bool p_is_cumulative = false);
